...
const Login = () => {
  ...
  return (
    <div className="bg-[#f9f9f9] text-[#1a1c1c] antialiased min-h-screen flex flex-col font-['Manrope']">
      ...
      <main className="flex flex-col md:flex-row md:items-stretch pt-[72px] min-h-screen">
        ...
        <section className="w-full h-[40vh] md:h-auto md:w-1/2 relative overflow-hidden bg-[#eeeeee]">
          ...
          />
          <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 z-20 max-w-md">
        ...
        <section className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-24 py-12 md:py-20 bg-[#f9f9f9]">
          <div className="max-w-md w-full mx-auto">
            <header className="mb-12">
              <h1 className="text-4xl md:text-5xl font-['Newsreader'] tracking-tight mb-2">Log In</h1>
              <p className="text-[#474747] font-['Manrope'] text-sm uppercase tracking-wider">Access your Snitch account</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="group relative">
                <div className="flex justify-between items-center mb-1">
                  <label className="block text-[10px] font-['Manrope'] uppercase tracking-[0.2em] text-[#474747]">Password</label>
                  <a href="#forgot" className="text-[10px] font-['Manrope'] text-[#474747] hover:text-black transition-colors">FORGOT PASSWORD?</a>
                </div>
                <input 
                  name="password"
            ...
            <div className="mt-10 flex flex-col items-center gap-6">
              <p className="text-[10px] font-['Manrope'] text-[#474747] tracking-widest uppercase">
                ...
                <a className="text-black font-bold border-b border-black ml-2 hover:opacity-70 transition-opacity" href="/register">Sign up</a>
              </p>
            </div>
          </div>
        </section>
