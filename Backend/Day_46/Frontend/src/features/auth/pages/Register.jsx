            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="flex items-center justify-between py-4 group">
                <div className="flex flex-col">
                  <span className="text-sm font-['Manrope'] uppercase tracking-widest text-[#1a1c1c]">
                    Become a Seller
                  </span>
                  <span className="text-[10px] text-[#474747] uppercase tracking-wider mt-1">
                    Access merchant tools and editorial dashboard
                  </span>
                </div>
